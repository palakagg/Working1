...
/**
 * Servlet implementation class AdminShortage1
 */
@WebServlet("/shortage1")
public class AdminShortage1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminShortage1() {
        super();
...
CompanyOperations cop = new CompanyOperationsImpl();
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("security_short.jsp");
