     ...
     <div id="nav">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <%
					Company list1 = (Company)request.getAttribute("table1");
               		List<Manages> list2 = (List<Manages>)request.getAttribute("table2");
               		String msg = null;
               		
               		if(list1.getNettedFunds()>=0)
               		{
               			msg = "NO NEEED TO BORROW FROM MARKET"; 
               		}
               		else if(list1.getNettedFunds()<0){
               			
               		    msg="BORROW FROM MARKET";
               		}
					%>
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                  ...
                  <h4 class="font-weight-normal mb-3">Available Funds
                    <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5"><%out.println(list1.getAvailableFunds()); %></h2>
                  <h6 class="card-text"><%out.println(msg); %></h6>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                  ...
                  <h4 class="font-weight-normal mb-3">Cost Of Funds Settlement
                    <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5"><%out.println(list1.getCostOfSettlementForFunds()); %></h2>
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" >
                  <h4 class="card-title">SECURITY SHORTAGES</h4>
                  ...
                  <table class="table table-dark">
                    <thead>
                      <tr>
                        ...
                        <th>
                          COST OF SETTLEMENT OF SECURITIES
                        </th>
                      </tr>
                    </thead>
                    <%
