      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <%
               		...
               		List<Security> list1 = (List<Security>)request.getAttribute("table1");
          ...
          <div class="row">
            <div class="col-md-8 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                                    <h4 class="font-weight-normal mb-3">Funds Borrowing Rate
                    <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5">1.25% per annum </h2>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" >
                  <h4 class="card-title">SECURITIES BORROWING RATES</h4>
                  ...
                  <table class="table table-dark">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <% out.println(t.getMarketPrice()); %>
                        </td>
                        <td>
                          <% out.println(t.getBorrowingRate()); %>
                        </td>
                      </tr>
                      <% } %>
                    </tbody>
